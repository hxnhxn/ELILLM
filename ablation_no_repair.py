...
def main(seed, exp_path=None, name_protein=None, dataset='pdb_bind'):
    ...
    # Loading Llama-3.1
    checkpoint = "yourpath/meta-llama/Llama-3.1-8B-Instruct/"
    device_num = 0
    ...
    # Init bayesianLLM
    repairer_prompt = open("prompt/no_repairer_prompt.txt", "r").read()
    ...
    for i in range(1, max_num_generations+1):
        ...
        #             if new_mol not in unique_molecules:
        #                 new_molecules.append(new_mol)
        #                 generated_source.append('explorer')
        #                 unique_molecules.add(new_mol)
        #             else:
        #                 print(f"{new_mol} is duplicated")
        #
...
if __name__ == "__main__":
    ...
    dataset = 'crossdocked'
    seed = 1
    exp_path = 'results/ablation_no_repair'
    for i in range(10):
        name_protein = str(i)
